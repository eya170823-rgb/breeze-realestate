    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 text-lg mb-10">노형동 · 연동 전문 | 브리즈부동산중개</p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-500 text-sm">노형동·연동 중심의 제주 부동산 전문 중개</p>
          </div>
          <div>
            <div className="text-yellow-600 text-3xl mb-4">🤝</div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-sm">제주특별자치도 제주시 노형동</p>
